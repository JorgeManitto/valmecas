<div class="w-full max-w-4xl bg-white rounded-lg shadow-lg p-6 mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
        ...
        <div class="flex flex-col gap-1">
            ...
            <input type="text" class="w-full border border-gray-400 rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500">
        </div>
        <div class="flex flex-col gap-1">
        ...
        <div class="flex flex-col gap-1">
            ...
            <select class="w-full border border-gray-400 rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500">
        ...
        <div class="col-span-1 sm:col-span-2 flex flex-col gap-1">
            ...
            <select class="w-full sm:w-1/2 border border-gray-400 rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500">
                <option>Selecciona</option>
            </select>
        </div>
    </div>
